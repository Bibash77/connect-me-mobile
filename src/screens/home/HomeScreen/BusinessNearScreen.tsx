...
import {useAllNearbyBussinessesMutation} from '@redux/features/businesses/businessService';
...
export default function BusinessNearScreen({navigation}: any) {
  ...
  const handleLoadMore = () => {
    if (hasMore && !networkCallStatus) {
      fetchNearBusiness(page + 1);
    }
  };
  const fetchNearBusiness = useCallback(
        ...
        {item.photos ? (
          ...
          <View
            ...
            <VectorIcon
              ...
              name={
                categories.find(c => c.name === item.category)?.icon || 'store'
              }
              size={48}
          ...
          <View style={styles.actionButtons}>
            <View style={styles.touchableWrapper}>
              <TouchableRipple
                ...
                borderless={true}
                onPress={() => Linking.openURL('tel:9841574348')}>
                <>
                  <VectorIcon
                    type={'materialCommunity'}
                    name="phone"
